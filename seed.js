...
const seedData = async () => {
  try {
    ...
    const guestUser = await User.create({
      name: 'Rahul Sharma (Sample Guest)',
    ...
    // Create physical rooms for Deluxe BLR
    ...
    // Create room for Goa
    const roomG1 = await Room.create({
      hotelId: hotel2._id,
    ...
    await PricingRule.create({
      roomTypeId: oceanViewGoa._id,
      hotelId: hotel2._id,
      season: 'Goa Weekend Getaway Surge',
      startDate: new Date('2026-09-01'),
    ...
    // Seed an already Checked-in booking
    const booking1 = await Booking.create({
      bookingReference: 'BK-SAMPLE01',
      ...
      checkInRemarks: 'Guest verified with Govt Photo ID. Room keycard issued.'
    });

    console.log('🎉 Database seeding finished successfully!');
    console.log('Credentials for testing:');
    console.log('  Admin: admin@hotel.com / Password123!');
    console.log('  Staff: staff@hotel.com / Password123!');
    console.log('  Guest: guest@hotel.com / Password123!');
